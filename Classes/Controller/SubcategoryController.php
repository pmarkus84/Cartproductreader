...
class SubcategoryController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
            ...
            \Pmwebdesign\Cartproductreader\Domain\Model\Maincategory $maincategory = null)
    {
        ...
        $this->redirect('edit', 'Category', null, ['category' => $category, 'maincategory' => $maincategory]);
    }
     ...
     * @return void
     */
    public function editAction(\Pmwebdesign\Cartproductreader\Domain\Model\Subcategory $subcategory,
            \Pmwebdesign\Cartproductreader\Domain\Model\Category $category,
            \Pmwebdesign\Cartproductreader\Domain\Model\Maincategory $maincategory = null)
    {
     ...
     * @return void
     */
    public function updateAction(\Pmwebdesign\Cartproductreader\Domain\Model\Subcategory $subcategory,
            \Pmwebdesign\Cartproductreader\Domain\Model\Category $category,
            \Pmwebdesign\Cartproductreader\Domain\Model\Maincategory $maincategory = null)
    {
        $this->addFlashMessage(\TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate('tx_cartproductreader_domain_model_subcategory', 'Cartproductreader') .
     ...
     * @return void
     */
    public function deleteAction(\Pmwebdesign\Cartproductreader\Domain\Model\Subcategory $subcategory,
            \Pmwebdesign\Cartproductreader\Domain\Model\Category $category,
            \Pmwebdesign\Cartproductreader\Domain\Model\Maincategory $maincategory = null)
    {
        $this->addFlashMessage(\TYPO3\CMS\Extbase\Utility\LocalizationUtility::translate('tx_cartproductreader_domain_model_subcategory', 'Cartproductreader') .
