...
- [META] Set the EM conf and json version number to 1.8.4.
- [BUGFIX] Fix search form in product list.
- [RELEASE] Version 1.8.3 with fixed issues.
...
- [META] Set the EM conf and json version number to 1.7.2.
- [BUGFIX] Image assign.
- [RELEASE] Version 1.7.1 with new small feature and fixed issues.
...
- [META] Set the EM conf and json version number to 1.7.0.
- [FEATURE] Add minimum number quantity and maincategory to excel import.
- [RELEASE] Version 1.6.4 with fixed issues.

## 1.6.4

Supports Typo3 8.7.0 - 9.5.99

- [META] Set the EM conf and json version number to 1.6.4.
- [RELEASE] Version 1.6.3 with fixed issues.

## 1.6.3

Supports Typo3 8.7.0 - 9.5.99

- [META] Set the EM conf and json version number to 1.6.3.
- [RELEASE] Version 1.6.2 with fixed issues.
